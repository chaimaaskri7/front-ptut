<template>
  <header class="bg-white border-b border-[#f0f0f0] px-[40px] py-[14px] flex items-center justify-center sticky top-0 z-[60] mb-4">
    <!-- Center Section -->
    <div class="flex flex-col leading-normal text-center">
      <p class="font-bold text-[24px] text-[#1b1b1b]">Dashboard</p>
      <p class="font-normal text-[14px] text-[#168bd9]">{{ subtitle }}</p>
    </div>

    <!-- Right Section (absolute positioned) -->
    <div class="absolute right-[40px] md:right-[20px] lg:right-[40px] flex gap-[25px] items-center">
      <!-- Search Bar -->
      <div class="search-bar bg-[#f8f8f8] border border-[#f0f0f0] rounded-[10px] px-[13px] py-[8px] flex gap-[11px] items-center w-[381px]">
        ...
        <input 
          type="text" 
          placeholder="Search" 
          class="bg-transparent border-none outline-none font-normal text-[16px] text-[#7f7f7f] flex-1"
        />
      </div>

      <!-- Notification Icon -->
      <div class="notification w-[32px] h-[32px] border border-[#f0f0f0] rounded-[5px] flex items-center justify-center cursor-pointer relative">
        <svg class="w-[20px] h-[20px]" fill="none" viewBox="0 0 24 24" stroke="#7F7F7F" stroke-width="1.5">
      ...
      <div class="user-profile flex gap-[8px] items-center cursor-pointer">
        <div class="w-[34px] h-[34px] rounded-[50px] overflow-hidden">
          <img 
        ...
        <div class="flex flex-col font-medium leading-normal gap-px w-[131px]">
          <p class="text-[#1b1b1b] text-[16px]">Dr Amirul Haque</p>
